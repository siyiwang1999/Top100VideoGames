...
The interactive chart below shows Top 100 video game platforms, and you can hover over it for more details. To follow up on relevant insights from platforms with relatively large mainstream and audience segments, the interactive chart also includes global sales for each game, as global sales can help understand the definitions and draw conclusions later on.
...
Hover over the chart below to learn about the specific platforms that support Top 100 video games and the number of games on each platform as a way to gain insight about the platforms favored by publishers.
...
If the two interactive charts above do not provide the most straightforward conclusions about the mainstream gaming platforms and the gaming platforms with the largest audiences, then the following interactive chart can help you to some extent. 
